...
Revision ID: c3d42456723d
Revises: 566362c673d4
Create Date: 2022-05-31 11:29:17.869276
...
revision = 'c3d42456723d'
down_revision = '566362c673d4'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('genre', postgresql.ARRAY(sa.VARCHAR()), autoincrement=False, nullable=False),
